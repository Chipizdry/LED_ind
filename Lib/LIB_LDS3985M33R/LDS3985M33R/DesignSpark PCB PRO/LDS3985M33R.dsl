...
(library Library_1
	...
	(compDef "LDS3985M33R" (originalName "LDS3985M33R") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "V1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "GND") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "VINH") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://componentsearchengine.com/Datasheets/1/LDS3985M33R.pdf")
		(attr "Height" "1.45 mm")
	)
