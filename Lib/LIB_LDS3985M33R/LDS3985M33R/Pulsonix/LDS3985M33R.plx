...
//424404/261166/2.49/5/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LDS3985M33R" (originalName "LDS3985M33R")
	...
	(compDef "LDS3985M33R" (originalName "LDS3985M33R") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "V1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "GND") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "VINH") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "BYPASS") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VO") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LDS3985M33R"))
		...
		(attr "Manufacturer_Part_Number" "LDS3985M33R")
		(attr "Mouser Part Number" "511-LDS3985M33R")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/LDS3985M33R?qs=DcAdhm6iCnom47SfkNYeVw%3D%3D")
		(attr "Arrow Part Number" "LDS3985M33R")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/lds3985m33r/stmicroelectronics?region=nac")
		(attr "Mouser Testing Part Number" "")
		(attr "Mouser Testing Price/Stock" "")
		(attr "Description" "STMicroelectronics LDS3985M33R, Single Low Dropout Voltage Regulator, 300mA 3.3 V, 5-Pin SOT-23")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/LDS3985M33R.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "LDS3985M33R.stp")
